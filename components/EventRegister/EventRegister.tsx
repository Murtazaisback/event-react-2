                                    ...
                                    <div className="event_from">
                                            ...
                                            <form action="">
                                                ...
                                                <div className="age_row">
                                                    <label className="switch">
                                                        <input type="checkbox" className="Present 1" name="attedence[]"
                                                            id="1" value="P"/>
                                        ...
                                        <div className="option">
                                            ...
                                            <div className="age_row">
                                                <label className="switch">
                                                    <input type="checkbox" className="Present 2" name="attedence[]"
                                                        id="watch-main" value="A"/>
                                                    <span className="slider round"></span>
                                                </label>
                                                <p>Let customers select their own seats</p>
                                            </div>
                                            <div className="main_optionsa" style={{display: "none"}} id="show-main">
                                                ...
                                                <div className="age_row">
                                                    <input type="radio" name="drone" value="dewey"
                                                        className="cursor_pointer" id='watch-me' />
                                                    <label htmlFor="dewey">Clone the existing Chart</label>
                                                </div>
                                                <div className="name_yourc" id='show-me' style={{display: "none"}}>
                                        ...
                                        <div className="next_btn">
                                            ...
                                            <a className="w3-bar-item w3-button tablink tab_btn cursor_pointer  "
                                                href="./newevent/Define Ticket Prices.html">Next</a>
